...
class Simulator:
    def __init__(self, checkpoint_path, sequence_loader='cmu_npz_smplx_zeropos',
    ...
    def run_zeropos(self, garment_name, n_steps=200, gender='female', **kwargs):
        sample = self._create_zeropos_sample(garment_name, n_steps, gender=gender, **kwargs)
        sample = move2device(sample, 'cuda')
